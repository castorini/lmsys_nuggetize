...
OPENAI_PRICING = {
    ...
    "gpt-4o-mini-batch-2": {"input": 0.075 / 1000000, "output": 0.30 / 1000000},
    "gpt-4o-mini-batch-fast-1": {"input": 0.075 / 1000000, "output": 0.30 / 1000000},
    "gpt-4o-mini-batch-fast-2": {"input": 0.075 / 1000000, "output": 0.30 / 1000000},
...
TOKENIZER_OPENAI = {
    ...
    "gpt-4o-mini-batch-2": 'o200k_base',
    "gpt-4o-mini-batch-fast-1": 'o200k_base',
    "gpt-4o-mini-batch-fast-2": 'o200k_base',
    "gpt-4o": 'o200k_base',
    ...
    def response(
        ...
        **kwargs,
        ...
        try:
            ...
            if self.deployment_name in ["o3-mini"]:
